(function () {
  ...
  const FALLBACK_CATEGORIES = [
    ...
    ['Action', '/c/action/', '/assest/icon/action.svg'],
    ['Adventure', '/c/adventure/', '/assest/icon/adventure.svg'],
    ['Arcade', '/c/arcade/', '/assest/icon/arcade.png'],
    ['Multiplayer', '/c/multiplayer/', '/assest/icon/multiplayer.svg'],
    ['Puzzle', '/c/puzzle/', '/assest/icon/puzzle.svg'],
    ['Racing', '/c/racing/', '/assest/icon/racing.png']
  ];
